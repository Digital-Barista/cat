...
public class ChartBase extends UIComponent implements IFocusManagerComponent
{
    ...
    public function ChartBase()
    {
        ...
        _allDataTipOverlay = new FlexShape();
   ...
   /**
     ...
     *  
     *  For example, if the left arrow or right arrow key was pressed, the direction is set to "H" 
     ...
     *  presses a key such as the left arrow.
     *  
     *  For example, if the up arrow or down arrow key was pressed, the direction is set to "V" 
    ...
    */
     ...
     *  Each chart contains one or more data transforms
     *  that represent a set of axes used to map from tuples
     *  from data space to screen space and vice-versa.
     *  Most charts have only a single DataTransform object,
     *  but CartesianChart controls that support second axes
     *  can manage a second DataTransform as needed.
     */
    [Deprecated(replacement="IChartElement2.dataTransform")]
    
    protected function get transforms():Array /* of DataTransform */
    {
        return _transforms;
    }
     ...
     *  @private
     */
    protected function set transforms(value:Array /* of DataTransform */):void
    {
        _transforms = value;
    ...
    public function get selectedChartItems():Array /* of ChartItem */
    {
        ...
        {
            for (var j:int = 0; j < series[i].selectedItems.length; j++)
            {
   ...
   /**
    ...
    public function getItemsInRegion(value:Rectangle):Array /* of ChartItem */
    {
        ...
        if(_transforms)
            ...
            {
                arrAllItems = arrAllItems.concat(getItemsInRegionFromElements(_transforms[i],value));
            }
     ...
     *                   are <code>ChartBase.NAVIGATE_HORIZONTAL</code>, <code>ChartBase.NAVIGATE_VERTICAL</code>, and 
     *                   <code>ChartBase.NONE</code>. Cartesian charts implement horizontal and vertical, and Polar charts 
     *                   implement none.
     ...
     *  
     *  @param dimension The dimension that you want to get the axis for.
     * 
    ...
    [Deprecated(replacement="Series.setAxis()")] 
    /**
     ...
     *  Call this method to transform data on to the screen
     *  by using the same transform that the individual elements use.
     *  For example, to create a custom highlight for a data region of a chart,
     *  you might use this method to determine the on-screen coordinates
     ...
     *  
     *  @param ...dataValues The data values to convert.
     *  
     ...
     *  The point is relative to the chart's coordinate space.</p>
     *  
     *  @param pt The Point object to convert.
     *  
   ...
   /**
    ...
    private function processRollEvents(hitSet:Array /* of HitData */, event:MouseEvent):void
    {
        ...
        {
            if(_selectionMode == "single" && event.type == flash.events.MouseEvent.MOUSE_DOWN)
            {
                clearSelection();
                return;
            }
            else if(_selectionMode == "multiple" && event.type == flash.events.MouseEvent.MOUSE_DOWN)
            {
                startTracking(event);
                return;
            }
        ...
        if(event.type == flash.events.MouseEvent.MOUSE_UP)
        {
  ...
  /**
   ...
   public function clearSelection():void
   {
     ...
     *  @private
     */
    private function getItemsInRegionFromElements(transform:DataTransform,value:Rectangle):Array /* of ChartItem */
    {
    ...
    private function track(e:MouseEvent):void 
    {
        ...
        dispatchRegionChange(e);
        e.stopPropagation();
    }

    private function dispatchRegionChange(e:MouseEvent):void
    {
        ...
        dispatchEvent(new RangeEvent(RangeEvent.REGION_CHANGE,r,e));
    }
    ...
    private function updateTrackBounds(mouseVals:Array):void
    {
...
class RangeEvent extends Event
{
     ...
     */
    public function RangeEvent(type:String, rect:Rectangle, e:MouseEvent)
    {               
        super(type);
