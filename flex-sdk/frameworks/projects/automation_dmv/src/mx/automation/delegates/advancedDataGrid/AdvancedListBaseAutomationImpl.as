 ...
 * 
 *  @see mx.controls.listClasses.AdvancedListBase 
 *
 */
public class AdvancedListBaseAutomationImpl extends ScrollControlBaseAutomationImpl 
{
    ...
    {
        Automation.registerDelegateClass(AdvancedListBase, AdvancedListBaseAutomationImpl);
    }   
    ...
    /**
     *  Constructor.
     * @param obj AdvancedListBase object to be automated.     
     */
     ...
     */
    //  kept the same name so that the implementation of
    // other methods need not be changed
    protected function get listBase():AdvancedListBase
    {
        return uiComponent as AdvancedListBase;
    }
    ...
    {
        return new AdvancedListBaseTabularData(listBase);
    }
    ...
    override public function replayAutomatableEvent(event:Event):Boolean
    {
        ...
        switch (event.type)
        {
            ...
            case ListItemSelectEvent.SELECT:
            {
                ...
                if(!lise.itemRenderer)
                {
                    // it was observed that during recording at some cases
                    // an empty select was getting recorded. this issue is not 
                    // reproducable with known steps.
                    // hence controlling the RTE at the time of replay
                    // this is not the final fix.
                    // we need to figure out the empty select recording scenario
                    return false;
                }
