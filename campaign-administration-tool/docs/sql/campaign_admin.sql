...
USE `campaign_admin_prod`;

-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`jms_messages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`jms_messages` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`jms_messages` (
  `MESSAGEID` INT(11) NOT NULL ,
  `DESTINATION` VARCHAR(150) NOT NULL ,
  `TXID` INT(11) NULL DEFAULT NULL ,
  `TXOP` CHAR(1) NULL DEFAULT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`jms_roles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`jms_roles` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`jms_roles` (
  `ROLEID` VARCHAR(32) NOT NULL ,
  `USERID` VARCHAR(32) NOT NULL ,
  PRIMARY KEY (`USERID`, `ROLEID`) )
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`jms_subscriptions`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`jms_subscriptions` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`jms_subscriptions` (
  `CLIENTID` VARCHAR(128) NOT NULL ,
  `SUBNAME` VARCHAR(128) NOT NULL ,
  `TOPIC` VARCHAR(255) NOT NULL ,
  `SELECTOR` VARCHAR(255) NULL DEFAULT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`jms_transactions`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`jms_transactions` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`jms_transactions` (
  `TXID` INT(11) NOT NULL DEFAULT '0' ,
  PRIMARY KEY (`TXID`) )
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`jms_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`jms_users` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`jms_users` (
  `USERID` VARCHAR(32) NOT NULL ,
  `PASSWD` VARCHAR(32) NOT NULL ,
  `CLIENTID` VARCHAR(128) NULL DEFAULT NULL ,
  PRIMARY KEY (`USERID`) )
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`roles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`roles` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`roles` (
  `role_pk` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key for this table' ,
  `username` VARCHAR(50) NOT NULL COMMENT 'Username applied to this table.' ,
  `role_name` VARCHAR(50) NOT NULL COMMENT 'Actual permission name' ,
  `role_type` VARCHAR(50) NULL DEFAULT NULL COMMENT 'Actual role type' ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`users` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`users` (
  `username` VARCHAR(50) NOT NULL COMMENT 'The case-sensitive login' ,
  `user_pk` BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key for the table' ,
  `password` VARCHAR(100) NOT NULL COMMENT 'The encrypted password for this account' ,
  `active` TINYINT(1) NOT NULL DEFAULT '1' COMMENT 'Flag set to disable an account.' ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`campaigns`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`campaigns` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`campaigns` (
  `campaign_id` INT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(200) NOT NULL ,
  `current_version` INT NOT NULL ,
  `uid` VARCHAR(36) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`nodes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`nodes` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`nodes` (
  `node_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `campaign_id` INT NOT NULL ,
  `type` INT NOT NULL ,
  `name` VARCHAR(200) NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`campaign_node_link`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`campaign_node_link` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`campaign_node_link` (
  `cnl_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `campaign_id` INT NOT NULL ,
  `node_id` BIGINT NOT NULL ,
  `version` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`campaign_versions`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`campaign_versions` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`campaign_versions` (
  `campaign_version_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `campaign_id` INT NOT NULL ,
  `version` INT NOT NULL ,
  `status` VARCHAR(45) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`node_info`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`node_info` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`node_info` (
  `node_info_id` BIGINT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`connectors`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`connectors` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`connectors` (
  `connector_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(200) NULL ,
  `type` INT NOT NULL ,
  `campaign_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`connector_info`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`connector_info` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`connector_info` (
  `connector_info_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(16) NOT NULL ,
  `value` VARCHAR(256) NOT NULL ,
  `connector_id` BIGINT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`campaign_connector_link`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`campaign_connector_link` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`campaign_connector_link` (
  `ccl_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `campaign_id` INT NOT NULL ,
  `connector_id` BIGINT NOT NULL ,
  `version` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`node_connector_link`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`node_connector_link` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`node_connector_link` (
  `node_connector_link_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `node_id` BIGINT NOT NULL ,
  `connector_id` BIGINT NOT NULL ,
  `version` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`layout_info`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`layout_info` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`layout_info` (
  `layout_info_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `campaign_id` INT NOT NULL ,
  `x_loc` INT NOT NULL ,
  `y_loc` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`client`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`client` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`client` (
  `client_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(64) NOT NULL ,
  `admin_add_in_message` VARCHAR(160) NULL ,
  `user_add_in_message` VARCHAR(160) NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`subscribers`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`subscribers` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`subscribers` (
  `subscriber_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `email` VARCHAR(128) NULL ,
  `phone_number` VARCHAR(16) NULL ,
  PRIMARY KEY (`subscriber_id`) ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`campaign_subscriber_link`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`campaign_subscriber_link` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`campaign_subscriber_link` (
  `campaign_subscriber_link_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `campaign_id` INT NOT NULL ,
  `subscriber_id` BIGINT NOT NULL ,
  `last_completed_node_id` BIGINT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`campaign_entry_points`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`campaign_entry_points` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`campaign_entry_points` (
  `campaign_entry_point_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `campaign_id` INT NOT NULL ,
  `entry_point_type` VARCHAR(64) NOT NULL ,
  `entry_point` VARCHAR(128) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`scheduled_campaign_tasks`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`scheduled_campaign_tasks` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`scheduled_campaign_tasks` (
  `scheduled_task_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `scheduled_date` DATETIME NOT NULL ,
  `source_uid` VARCHAR(36) NOT NULL ,
  `target` VARCHAR(36) NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`entry_points`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`entry_points` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`entry_points` (
  `entry_point_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `description` VARCHAR(128) NULL ,
  `entry_point` VARCHAR(64) NOT NULL ,
  `entry_type` VARCHAR(32) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`client_entry_point_link`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`client_entry_point_link` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`client_entry_point_link` (
  `client_entry_point_link_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `client_id` BIGINT NOT NULL ,
  `entry_point_id` BIGINT NOT NULL ,
  PRIMARY KEY (`client_entry_point_link_id`) ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`keywords`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`keywords` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`keywords` (
  `keyword_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `entry_point_id` BIGINT NOT NULL ,
  `keyword` VARCHAR(64) NOT NULL ,
  `client_id` BIGINT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`audit_incoming_message`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`audit_incoming_message` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`audit_incoming_message` (
  `incoming_audit_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `incoming_address` VARCHAR(64) NOT NULL ,
  `incoming_type` VARCHAR(16) NOT NULL ,
  `date_received` DATETIME NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`audit_outgoing_message`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`audit_outgoing_message` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`audit_outgoing_message` (
  `audit_outgoing_message_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `node_uid` VARCHAR(36) NOT NULL ,
  `node_version` INT NOT NULL ,
  `destination` VARCHAR(64) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`subscriber_blacklist`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`subscriber_blacklist` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`subscriber_blacklist` (
  `subscriber_blacklist_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `subscriber_id` BIGINT NOT NULL ,
  `incoming_address` VARCHAR(64) NOT NULL ,
  `incoming_type` VARCHAR(32) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `campaign_admin_prod`.`audit_generic`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `campaign_admin_prod`.`audit_generic` ;

CREATE  TABLE IF NOT EXISTS `campaign_admin_prod`.`audit_generic` (
  `audit_id` BIGINT NOT NULL AUTO_INCREMENT ,
  `audit_type` VARCHAR(32) NOT NULL ,
  `audit_time` DATETIME NOT NULL ,
  `descriminator_1` VARCHAR(36) NULL ,
