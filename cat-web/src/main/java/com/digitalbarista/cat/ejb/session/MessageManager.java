...
public class MessageManager {
	...
	public CampaignMessagePart getMessagePart(Campaign campaign, EntryPointType entryType, String message) 
	{
			...
			campaign.getClientPK() != 0)
		{
			...
			CampaignDO campaignDO = (CampaignDO)sf.getCurrentSession().get(CampaignDO.class, campaign.getPrimaryKey());
			if (campaignDO != null)
			{
			...
			ClientDO clientDO = (ClientDO)sf.getCurrentSession().get(ClientDO.class, campaign.getClientPK());
